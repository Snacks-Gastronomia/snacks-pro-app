class PosPrintResult {
  ...
  static const notFound = PosPrintResult._internal(7);

  String get msg {
    if (value == PosPrintResult.success.value) {
      return 'Success';
    } else if (value == PosPrintResult.notFound.value) {
      return 'Error. No route to host (OS Error: No route to host, errno = 113)';
