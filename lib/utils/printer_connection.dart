...
/// Network Printer
class AppNetworkPrinter {
  AppNetworkPrinter(this._paperSize, this._profile,
  ...
  Future<PosPrintResult> connect(String host,
    ...
    _port = port;
    // try {
    return await Socket.connect(host, port, timeout: timeout).then((value) {
      _socket.add(_generator.reset());

      return Future<PosPrintResult>.value(PosPrintResult.success);
    }).catchError(
      (err) => Future<PosPrintResult>.value(PosPrintResult.notFound),
    );
